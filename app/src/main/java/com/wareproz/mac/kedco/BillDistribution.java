...
public class BillDistribution extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        datepicked = (DatePicker) findViewById(R.id.datePicker3);
        ...
        getDetails.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(customerAccNo.trim().length() > 0 ){
                    ...
                    new BillDistribution.GetCustomerDetails().execute();

                }else{
                    Toast.makeText(BillDistribution.this,"Enter Customer Account number first",Toast.LENGTH_LONG).show();
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(customerId.length() > 0 ){
                    ...
                    Toast.makeText(BillDistribution.this,"No customer selected",Toast.LENGTH_LONG).show();
    ...
    private class GetCustomerDetails extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(BillDistribution.this);
        ...
        protected void onPostExecute(Void result) {
            ...
            if (json_status.equals("1")){
                ...
                //
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(BillDistribution.this);
