...
public class FaultReportingConfirmation extends BaseActivity implements SeekBar.OnSeekBarChangeListener  {
    ...
    private class confirmer extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(FaultReportingConfirmation.this);
            pDialog.setMessage("Submitting fault report ...");
        ...
        protected void onPostExecute(Void result) {
            ...
            if (json_status.equals("1")){
                ...
                Toast.makeText(FaultReportingConfirmation.this,msg,Toast.LENGTH_LONG).show();

                Intent mIntent = new Intent(FaultReportingConfirmation.this, HomeActivity.class);
                startActivity(mIntent);

            }else{
                //
                Toast.makeText(FaultReportingConfirmation.this,"Unable to Submit",Toast.LENGTH_LONG).show();
                finish();
            }
        }
