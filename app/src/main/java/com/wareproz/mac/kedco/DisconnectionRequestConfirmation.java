...
public class DisconnectionRequestConfirmation extends BaseActivity implements SeekBar.OnSeekBarChangeListener  {
...
protected void onCreate(Bundle savedInstanceState) {
    ...
    private class confirmer extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(DisconnectionRequestConfirmation.this);
            pDialog.setMessage("Submitting disconnection request ...");
        ...
        protected void onPostExecute(Void result) {
            ...
            if (json_status.equals("1")){
                ...
                Intent mIntent = new Intent(DisconnectionRequestConfirmation.this, HomeActivity.class);
