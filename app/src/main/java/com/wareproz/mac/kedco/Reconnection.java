...
public class Reconnection extends BaseActivity {
    ...
    private static String url = "reconnection.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Reconnection.GetContacts().execute();
    }
    ...
    private class GetContacts extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(Reconnection.this);
            pDialog.setMessage("Loading reconnections ... ");
            ...
            lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position,
                    ...
                    if (Integer.parseInt(role) != 3){
                        ...
                        Toast.makeText(Reconnection.this,"You dont have permission to perform this action",Toast.LENGTH_LONG).show();
                        ...
                        alertDialogBuilder.setPositiveButton("yes",
                                new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface arg0, int arg1) {
                                        new Reconnection.confirmer().execute();
                                    }
                                });
    ...
    private class confirmer extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            // Making a request to url and getting response
            String url = "confirm.php?id="+ selecteditem +"&what=reconnection";
        ...
        protected void onPostExecute(Void result) {
            ...
            if (json_status.equals("1")){
                ...
                Toast.makeText(Reconnection.this,json_msg,Toast.LENGTH_LONG).show();
                finish();

            }else{
                //
                Toast.makeText(Reconnection.this,"Unable to confirm, try again",Toast.LENGTH_LONG).show();
            }
        }
