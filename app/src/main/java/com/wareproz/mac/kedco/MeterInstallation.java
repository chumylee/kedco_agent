...
public class MeterInstallation extends BaseActivity {
        ...
        getDetails.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(customerAccNo.trim().length() > 0 ){
                    ...
                    new MeterInstallation.GetCustomerDetails().execute();

                }else{
                    Toast.makeText(MeterInstallation.this,"Enter Customer Account number first",Toast.LENGTH_LONG).show();
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(customerId.length() > 0 ){
                    ...
                    Intent changer = new Intent(MeterInstallation.this, MeterInstallationConfirmation.class);
                    ...
                    Toast.makeText(MeterInstallation.this,"No customer selected",Toast.LENGTH_LONG).show();
    ...
    private class GetCustomerDetails extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(MeterInstallation.this);
        ...
        protected void onPostExecute(Void result) {
            ...
            if (json_status.equals("1")){
                ...
                //
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(MeterInstallation.this);
