...
public class MeterBypassConfirmation extends BaseActivity implements SeekBar.OnSeekBarChangeListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_meter_bypass_confirmation);
    ...
    private class confirmer extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(MeterBypassConfirmation.this);
            pDialog.setMessage("Submitting bypass check ...");
        ...
        protected void onPostExecute(Void result) {
            ...
            if (json_status.equals("1")){
                ...
                Intent mIntent = new Intent(MeterBypassConfirmation.this, HomeActivity.class);
