...
public class ReconnectionRequestConfirmation extends BaseActivity implements SeekBar.OnSeekBarChangeListener  {
    ...
    public void onProgressChanged(SeekBar seekBar, int i, boolean b) {
        if(i == 100)
        {
            new ReconnectionRequestConfirmation.confirmer().execute();
        }
    }
    ...
    private class confirmer extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(ReconnectionRequestConfirmation.this);
            pDialog.setMessage("Submitting reconnection request ...");
        ...
        protected void onPostExecute(Void result) {
            ...
            if (json_status.equals("1")){
                ...
                Intent mIntent = new Intent(ReconnectionRequestConfirmation.this, HomeActivity.class);
