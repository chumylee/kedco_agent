...
public class BillDistributionConfirmation extends BaseActivity implements SeekBar.OnSeekBarChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bill_distribution_confirmation);
    ...
    private class confirmer extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(BillDistributionConfirmation.this);
            pDialog.setMessage("Submitting bill distribution ...");
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            String url = "billDistributionSubmit.php?customer_id="+ customerId +"&bill_period="+ billDate +"&salesrep="+ cid;
        ...
        protected void onPostExecute(Void result) {
            ...
            if (json_status.equals("1")){
                ...
                Toast.makeText(BillDistributionConfirmation.this,msg,Toast.LENGTH_LONG).show();

                //push info to users


                Intent mIntent = new Intent(BillDistributionConfirmation.this, HomeActivity.class);
