...
public class FaultReporting extends BaseActivity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getDetails.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(customerAccNo.trim().length() > 0 ){
                    ...
                    new FaultReporting.GetCustomerDetails().execute();

                }else{
                    Toast.makeText(FaultReporting.this,"Enter Customer Account number first",Toast.LENGTH_LONG).show();
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(customerId.length() > 0 ){
                    ...
                    Intent changer = new Intent(FaultReporting.this, FaultReportingConfirmation.class);
                    ...
                    Toast.makeText(FaultReporting.this,"No customer selected",Toast.LENGTH_LONG).show();
        ...
        categories.add("FAULT 1");
        categories.add("FAULT 2");
        categories.add("FAULT 3");
    ...
    private class GetCustomerDetails extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(FaultReporting.this);
        ...
        protected void onPostExecute(Void result) {
            ...
            if (json_status.equals("1")){
                ...
                //
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(FaultReporting.this);
