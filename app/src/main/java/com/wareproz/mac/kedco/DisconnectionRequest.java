...
public class DisconnectionRequest extends BaseActivity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_disconnection_request);
        ...
        inputtext = (Spinner) findViewById(R.id.bypass);
        ...
        getDetails.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(customerAccNo.trim().length() > 0 ){
                    ...
                    new DisconnectionRequest.GetCustomerDetails().execute();

                }else{
                    Toast.makeText(DisconnectionRequest.this,"Enter Customer Account number first",Toast.LENGTH_LONG).show();
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(customerId.length() > 0 ){
                    ...
                    Intent changer = new Intent(DisconnectionRequest.this, DisconnectionRequestConfirmation.class);
                    ...
                    Toast.makeText(DisconnectionRequest.this,"No customer selected",Toast.LENGTH_LONG).show();
        ...
        categories.add("NON PAYMENT");
        categories.add("FAULT/REPAIRS");
    ...
    private class GetCustomerDetails extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(DisconnectionRequest.this);
        ...
        protected void onPostExecute(Void result) {
            ...
            if (json_status.equals("1")){
                ...
                //
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(DisconnectionRequest.this);
