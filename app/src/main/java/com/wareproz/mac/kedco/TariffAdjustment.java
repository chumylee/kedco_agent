...
public class TariffAdjustment extends BaseActivity {
    ...
    private static String url = "tariffadjustment.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new TariffAdjustment.GetContacts().execute();
    }
    ...
    private class GetContacts extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(TariffAdjustment.this);
            pDialog.setMessage("Loading tariff adjustments ... ");
    ...
    private class confirmer extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            // Making a request to url and getting response
            String url = "confirm.php?id="+ selecteditem +"&what=tariffadjustment";
        ...
        protected void onPostExecute(Void result) {
            ...
            if (json_status.equals("1")){
                ...
                Toast.makeText(TariffAdjustment.this,json_msg,Toast.LENGTH_LONG).show();
                finish();

            }else{
                //
                Toast.makeText(TariffAdjustment.this,"Unable to confirm, try again",Toast.LENGTH_LONG).show();
            }
        }
